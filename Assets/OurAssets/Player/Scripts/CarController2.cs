...
public abstract class CarController2 : MonoBehaviour
{
    ...
    protected virtual void UpdateHealth(float healthModification)
    {
        // Update value with limits
        CurrentHealth = Mathf.Clamp(CurrentHealth - healthModification, 0, MaxHealth);
    ...
    protected void OnCollisionEnter(Collision collision)
    {
        ...
        CarController2 otherCar = collision.gameObject.GetComponent<CarController2>();
